TC ID: TC001 | Title: Local Time Zone Conversion (DUPLICATE of original TC010) | Work Item ID: 1571
...
TC ID: TC002 | Title: Pagination Control — Concurrent Booking Attempt | Work Item ID: 1571
...
Test Step: 1 | Test Step Description: Select the target option from 'My Appointments' view for Pagination Control
Test Step Expected Result: Correct data visual tags render cleanly without page overflow.

TC ID: TC003 | Title: Pagination Control — Slow Network Retry | Work Item ID: 1571
Description: Verify behavior of Pagination Control under standard network load conditions
Precondition: Database populated with active patient appointment records.
Test Step: 1 | Test Step Description: Select the target option from 'My Appointments' view for Pagination Control
Test Step Expected Result: Correct data visual tags render cleanly without page overflow.

TC ID: TC004 | Title: Cancel Appointment Modal — Browser Back Button | Work Item ID: 1571
...
TC ID: TC005 | Title: Appointment Reminder Toggle — Low Bandwidth Mode | Work Item ID: 1571
...
Test Step: 1 | Test Step Description: Submit the request form and observe screen update for Appointment Reminder Toggle
